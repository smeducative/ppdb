<div class="bg-red-700">
    ...
    <main class="max-w-screen-xl mx-auto px-5 grid lg:grid-cols-2 place-items-center pt-3 pb-8 md:pb-0 md:pt-8">
        <div class="md:order-1 block" data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear"
            data-aos-offset="70">
            <img src='/img/siswa-1.png' alt="siswa" class="w-full max-w-md mx-auto p-5 md:p-0" />
        </div>
        <div data-aos="fade-right" data-aos-duration="1000" data-aos-easing="linear" data-aos-offset="70">
            ...
            <div class="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <x-ui.link size="lg" style="outline" rel="noopener"
                    href="https://drive.google.com/file/d/1viMI8Zi_zrnO0Pg0SjXi_DOJHtzDTSn7/view?usp=sharing"

<!-- header -->
    ...
    <table style="margin-top: 18px; font-size: 19px;" width="55%">
        <tr>
            <td width="13%">No</td>
            <td>:</td>
...
<p style="font-size: 18px;">
    Teriring puja dan puji syukur kehadirat Allah SWT serta Sholawat salam teruntuk Baginda Rasulullah SAW. Bersama ini kami
...
<p style="margin-top: 18px;">
    Berdasarkan hasil ujian seleksi Penerimaan Peserta Didik Baru SMK Diponegoro TA. {{ now()->year }}/{{ now()->addYear()->year }} dinyatakan :
</p>
...
<div class="mt-2" style="font-size: 18px;">
    ...
    Biaya registrasi yang telah dibayarkan ke SMK Diponegoro Karanganyar <strong>tidak dapat diambil</strong> kembali apabila Putra/Putri
    Bapak/Ibu diterima di SMA/SMK lain dengan syarat dan ketentuan yang telah ditetapkan sekolah. Adapun besaran biaya

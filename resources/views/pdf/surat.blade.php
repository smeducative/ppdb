                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <span> {{ optional((new App\Models\PpdbSetting())->latest()->first()->body)['no_surat'] }}
                                    </span>
                                </div>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('ppdb.set.batas.akhir') }}" class="btn btn-primary"
                                    type="submit">Atur</a>
                            </div>
                            </form>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    ...
                                    <form action="{{ route('ppdb.cetak.surat.semua', ['jurusan' => $jurusan]) }}"
                                        method="POST">
                                        @csrf
                                                ...
                                                @foreach ($pesertappdb as $peserta)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('ppdb.cetak.surat', $peserta->id) }}"
                                                                method="POST">
                                                                @csrf

                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    ...
                                    <form action="{{ route('export.seragam') }}?jurusan={{ request()->segment(4) }}"
                                        method="POST">
                                        @csrf
                                            ...
                                            <tbody>
                                                @foreach ($pesertappdb as $peserta)
                                                    <tr>
                                                        ...
                                                        <td> {{ $peserta->jenis_kelamin == 'l' ? 'Laki-laki' : 'Perempuan' }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary ukuran-seragam"
                                                                ...
                                                                data-peci="{{ $peserta->ukuranSeragam->peci ?? '-' }}">Ubah</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>

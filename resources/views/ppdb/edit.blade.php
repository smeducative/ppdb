...
<div class="content-wrapper">
    ...
    <section class="content">
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <div id="identitas-diri" class="content" role="tabpanel" aria-labelledby="identitas-diri-part-trigger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_lengkap" id="name" value="{{ $peserta->nama_lengkap }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="l" {{ $peserta->jenis_kelamin == "l" ? 'checked=""' : '' }}>
                                                    <label class="form-check-label">Laki-laki</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="p" {{ $peserta->jenis_kelamin == "p" ? 'checked=""' : '' }}>
       ...
       value="{{ $peserta->tanggal_lahir->format('d-m-Y') }}"                                                  data-mask required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nik" value="{{ $peserta->nik }}" placeholder="NIK" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="pjurusan" style="width: 100%;" name="pilihan_jurusan" required>
                                                    ...
                                                    <option value="{{ $jrs->id }}" {{ $peserta->jurusan_id == $jrs->id ? "selected" : '' }}>{{ $jrs->nama }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="asal_sekolah" value="{{ $peserta->asal_sekolah }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="tlulus" name="tahun_lulus" style="width: 100%;" required>
                                                    ...
                                                    <option value="{{ $i }}" {{ $peserta->tahun_lulus == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>NISN</label>
                                                <input type="text" class="form-control" name="nisn" value="{{ $peserta->nisn }}" placeholder="NISN">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox mb-2" onclick="fkip()">
                                                    <input type="checkbox" name="penerima_kip" class="custom-control-input" id="pkip" {{ $peserta->penerima_kip == "y" ? 'checked' : '' }}>
                                                    <label class="custom-control-label" for="pkip">Peserta penerima KIP</label>
                                                </div>

                                                <input id="input-kip" type="text" class="form-control" name="no_kip" value="{{ $peserta->no_kip }}" placeholder="No. KIP" disabled>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="no_hp" placeholder="No. HP" value="{{ $peserta->no_hp }}" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_ayah" class="form-control" placeholder="Nama Ayah" value="{{ $peserta->nama_ayah }}" required/>									<div class="form-text text-xs text-muted">Nama lengkap ayah</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>No. HP Ayah</label>
                                                        <input type="text" name="no_ayah" class="form-control" placeholder="No. HP Ayah"  value="{{ $peserta->no_hp_ayah }}"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="pekerjaan_ayah" class="form-control" placeholder="Pekerjaan ayah"  value="{{ $peserta->pekerjaan_ayah }}"/>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_ibu" class="form-control" placeholder="Nama Ibu" value="{{ $peserta->nama_ibu }}" required/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="no_ibu" class="form-control" placeholder="No. HP Ayah" value="{{ $peserta->no_hp_ibu }}"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="pekerjaan_ibu" class="form-control" placeholder="Pekerjaan Ibu" value="{{ $peserta->pekerjaan_ibu }}"/>
         					...
         					<div class="form-text text-xs text-muted">format: kelas / semester / peringkat. contoh: 9/1/1</div>                                               <!-- /.input group -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="hafidz" placeholder="Hafidz / Hafidzoh" value="{{ $peserta->akademik['hafidz'] ?? '' }}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="jenis_lomba" placeholder="misal: kejuaraan catur" value="{{ $peserta->non_akademik['jenis_lomba'] ?? '' }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Juara ke</label>
                                                        <input type="number" class="form-control" name="juara_ke" placeholder="Juara ke" value="{{ $peserta->non_akademik['juara_ke'] ?? '' }}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="jtingkat" style="width: 100%;" name="juara_tingkat">
                                                            ...
                                                            <option value="{{ $tingkat }}" {{ ($peserta->non_akademik['juara_tingkat']) ? $peserta->non_akademik['juara_tingkat'] == $tingkat ? 'selected' : '' : '' }}>{{ $tingkat }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-2">
                                                        <input type="checkbox" name="rekomendasi_mwc" class="custom-control-input" id="mwc" {{ $peserta->rekomendasi_mwc ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="saran_dari" placeholder="Saran dari siapa?" value="{{ $peserta->saran_dari }}" />
                                                    </div>
                                                </div>
                                            </div> <!-- row -->

                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form
                                        action="{{ route('ppdb.rekap.kwitansi-dana') }}?tahun={{ request('tahun', now()->year) }}"
                                        method="POST">
                                        @csrf
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form
                                        action="{{ route('ppdb.rekap.kwitansi-riwayat') }}?tahun={{ request('tahun', now()->year) }}"
                                        method="POST">
                                        @csrf
                                                ...
                                                <tr @class([
                                                    ...
                                                    <td>
                                                        @if (!$kwitansi->deleted_at)
                                                            <form
                                                                action="{{ route('ppdb.cetak.kwitansi.single', ['uuid' => $kwitansi->pesertaPpdb->id, 'id' => $kwitansi->id]) }}"
                                                                method="POST">
                                                                @csrf

...
import { GraduationCap, Trophy, Users, Leaf, BookOpen, Clock } from "lucide-react"
...
const scholarships = [
  {
    ...
    requirement: "Dibuktikan dengan fotokopi raport yang dilegalisir & surat keterangan dari Kepala Sekolah SMP/MTs",
  },
  {
    icon: Trophy,
  ...
  },
  {
    ...
    benefits: [{ rank: "Hafal 1 Juz+", reward: "Bebas Biaya Pendidikan Selama Sekolah" }],
  ...
  },
  {
    ...
    benefits: [{ rank: "Jurusan AT", reward: "Subsidi SPP 50% selama 3 Tahun" }],
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div ref={titleRef} className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Program Beasiswa</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            SMK Diponegoro Karanganyar menyediakan berbagai program beasiswa untuk meringankan biaya pendidikan.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground text-lg">{scholarship.title}</h3>
                ...
                <div className="space-y-2 mb-4">
                  {scholarship.benefits.map((benefit, i) => (
                    <div key={i} className="flex items-center justify-between p-3 bg-secondary/50 rounded-xl">
                      <span className="text-sm text-foreground font-medium">{benefit.rank}</span>
                      <span className="text-sm text-primary font-bold">{benefit.reward}</span>
                    </div>
                  ))}
                </div>

                <p className="text-xs text-muted-foreground italic border-t pt-3">*{scholarship.requirement}</p>
              </div>
            </div>
          ))}
        </div>

...
import { Trophy, Palette, Music, Tent, Heart, BookOpen, Flag, Users } from "lucide-react"
...
const extracurriculars = [
  {
    icon: Trophy,
    name: "Olahraga",
    description: "Futsal, Voli, Basket - raih prestasi dan beasiswa non-akademik",
    color: "bg-orange-500",
  },
  {
    icon: Palette,
...
export function ExtracurricularSection() {
  ...
  return (
    <section ref={sectionRef} id="ekskul" className="py-24 md:py-32 bg-secondary/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div ref={titleRef} className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Ekstrakurikuler</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Kembangkan minat dan bakatmu. Prestasi di bidang olahraga & seni bisa mendapat beasiswa!
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {extracurriculars.map((ekskul, index) => (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">{ekskul.description}</p>
            </div>
          ))}
        </div>
      </div>

...
import { ClipboardList, FileText, CreditCard, Building } from "lucide-react"
...
const steps = [
  ...
  },
  {
    icon: CreditCard,
    title: "Daftar Ulang",
    description: "Setelah dinyatakan diterima, peserta PPDB membayar biaya daftar ulang sebesar Rp. 250.000,-",
  },
  {
    icon: Building,
    title: "Serahkan Berkas",
    description: "Berkas Pendaftaran dan Biaya Daftar Ulang diserahkan langsung ke SMK Diponegoro Karanganyar.",
  },
]
...
export function RegistrationFlow() {
  ...
  return (
    <section ref={sectionRef} id="alur" className="py-24 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={titleRef} className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Alur Pendaftaran</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Proses pendaftaran yang mudah dan transparan. Ikuti langkah-langkah berikut untuk menjadi bagian dari SMK
            Diponegoro Karanganyar.
          </p>
        </div>
        ...
        <div className="relative">
          <div
            ref={lineRef}
            className="hidden md:block absolute top-16 left-[10%] right-[10%] h-1 bg-gradient-to-r from-primary/20 via-primary to-primary/20 rounded-full origin-left"
          />

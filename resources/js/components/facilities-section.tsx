...
const facilities = [
	{
		icon: Building,
		name: "Ruang Teori",
		description: "Ruang kelas nyaman & kondusif",
	},
	{
		icon: Building,
		name: "Masjid",
		description: "Tempat ibadah yang representatif",
	},
	{
		icon: Monitor,
		name: "Lab TJKT ber-AC",
		description: "Lab komputer dengan pendingin",
	},
	{
		icon: Wrench,
		name: "Lab Otomotif",
		description: "Praktik kendaraan lengkap",
	},
	{
		icon: Leaf,
		name: "Lab Agribisnis Tanaman",
		description: "Praktik budidaya tanaman",
	},
	{
		icon: Monitor,
		name: "Lab SIMDIG ber-AC",
		description: "Simulasi digital modern",
	},
	{
		icon: Warehouse,
		name: "Green House",
		description: "Rumah kaca untuk pertanian",
	},
	{
		icon: Utensils,
		name: "Kantin Sekolah",
		description: "Makanan sehat & terjangkau",
	},
	{ icon: BookOpen, name: "Perpustakaan", description: "Koleksi buku lengkap" },
	{
		icon: Dumbbell,
		name: "Lapangan Olahraga",
		description: "Voli, Futsal, Basket",
	},
];
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div ref={titleRef} className="text-center mb-16">
					...
					<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
						Fasilitas sekolah yang lengkap dan memadai untuk mendukung kegiatan
						belajar mengajar.
					</p>
				</div>
				...
				>
					...
					<div className="absolute bottom-0 left-0 right-0 p-8">
						...
						<p className="text-white/80">
							Dilengkapi perangkat terbaru untuk mendukung pembelajaran praktik
						</p>
					</div>
				</div>
			</div>
